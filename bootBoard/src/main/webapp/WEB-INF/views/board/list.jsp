        ...
        <div class="section">
            ...
            <div class="search-box">
                <form action="/chat/search" method="get">
                    <select name="searchType" class="selectBox">
                        <option value="message">채팅 내용</option>
                        <option value="sender">채팅 전송자</option>
                    </select>
                    <input type="text" name="keyword" placeholder="검색할 내용을 입력하세요">
                    <input type="submit" value="검색">
                </form>
            ...
            <ul class="pagination">
                <c:forEach begin="1" end="${totalPages}" var="i">
                    <li><a href="?page=${i}&size=${size}">${i}</a></li>
                </c:forEach>
            </ul>
        </div>
    </div>
